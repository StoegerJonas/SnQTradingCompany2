...
{
    using System;
    partial class Order : SnQTradingCompany.Contracts.Persistence.App.IOrder
    {
        static Order()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTradingCompany.Contracts.Persistence.App.IOrder instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTradingCompany.Contracts.Persistence.App.IOrder other)
        {
            if (other == null)
            {
                return false;
            }
            return ProductId == other.ProductId && CostumerId == other.CostumerId && CreatedOn == other.CreatedOn && Count == other.Count && PriceNet == other.PriceNet && Discount == other.Discount;
        }
        public override int GetHashCode()
        {
            return HashCode.Combine(ProductId, CostumerId, CreatedOn, Count, PriceNet, Discount);
        }
