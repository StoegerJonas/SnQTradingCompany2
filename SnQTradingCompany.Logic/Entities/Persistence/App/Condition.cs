...
{
    using System;
    partial class Condition : SnQTradingCompany.Contracts.Persistence.App.ICondition
    {
        static Condition()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTradingCompany.Contracts.Persistence.App.ICondition instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTradingCompany.Contracts.Persistence.App.ICondition other)
        {
            if (other == null)
            {
                return false;
            }
            return ProductId == other.ProductId && CostumerId == other.CostumerId && ConditionType == other.ConditionType && Quantity == other.Quantity && Value == other.Value;
        }
        public override int GetHashCode()
        {
            return HashCode.Combine(ProductId, CostumerId, ConditionType, Quantity, Value);
        }
