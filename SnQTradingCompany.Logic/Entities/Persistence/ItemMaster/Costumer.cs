...
{
    using System;
    partial class Costumer : SnQTradingCompany.Contracts.Persistence.ItemMaster.ICostumer
    {
        static Costumer()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQTradingCompany.Contracts.Persistence.ItemMaster.ICostumer instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQTradingCompany.Contracts.Persistence.ItemMaster.ICostumer other)
        {
            if (other == null)
            {
                return false;
